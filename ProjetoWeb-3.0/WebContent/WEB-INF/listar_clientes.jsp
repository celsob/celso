<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.ArrayList, to.ClienteTO"%>
	...
	<div id="main" class="container-fluid">
		<form action="listar_clientes.do" method="post">
			<div id="top" class="row">
				...
				<div class="col-md-3">
					<a href="criar_cliente.html" class="btn btn-primary pull-right h2">Novo
						Cliente</a>
				</div>
			</div>
			<!-- /#top -->
		...
		<div id="list" class="row">
			...
			<div class="table-responsive col-md-12">
				<table class="table table-striped" cellspacing="0" cellpadding="0">
					...
					<tbody>
						<%
							ArrayList<ClienteTO> lista = (ArrayList<ClienteTO>) request.getAttribute("lista");
						...
						<tr>
							...
							<td class="actions"><a class="btn btn-success btn-xs"
								href="ManterCliente.do?acao=Visualizar&id=<%=to.getId()%>">Visualizar</a>
								<a class="btn btn-warning btn-xs"
								href="ManterCliente.do?acao=Editar&id=<%=to.getId()%>">Editar</a>
								<button id="btn<%=to.getId()%>" type="button"
